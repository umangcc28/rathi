...
$desktop_image = get_field('desktop_image',$shop_page_id);
$tablet_image = get_field('tablet_image',$shop_page_id);
$mobile_image = get_field('mobile_image',$shop_page_id);
$banner_head = get_field('banner_title',$shop_page_id);
$banner_subhead = get_field('sub_text',$shop_page_id);
...
<?php endif; ?> 
<!-- End Banner Section  -->
<div class="">sdfsdfsdfsdfsdsd</div>
