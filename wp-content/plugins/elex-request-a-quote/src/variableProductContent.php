...
<tr>
	...
	<?php if ( ( true !== $is_hide_price_enabled ) || ( 'quote-approved' === $order->get_status() ) ) { ?>
		<?php echo ( 0 !== $product_variation->get_price() && '' !==$product_variation->get_price() && '0' !== $product_variation->get_price() ) ? esc_html( TemplateModel::get_price_with_currency( number_format($product_variation->get_price() , 2) ) ) : 0; ?>
