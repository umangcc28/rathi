<table
		style="width: 100%;max-width: 700px; min-width: 350px; margin: 0 auto; background-color: #fff; padding: 20px;">
		
		<tbody>
			<tr>
				<td>
					<h1 style="text-align:center; margin: 10px 0 10px 0"><?php esc_html_e( 'Received a Quote!' , 'elex-request-a-quote' ); ?></h1>
				</td>
			</tr>
